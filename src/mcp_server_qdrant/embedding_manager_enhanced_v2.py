...
class EnhancedEmbeddingModelManager:
    ...
    async def set_collection_model(self, collection_name: str, model_name: str) -> bool:
        ...
        try:
            ...
            success = await self._store_collection_model_mapping(collection_name, model_name, model_info.vector_size)
    ...
    async def _store_collection_model_mapping(self, collection_name: str, model_name: str, vector_size: int) -> bool:
        ...
        try:
            ...
            point_id = f"mapping_{collection_name}"
