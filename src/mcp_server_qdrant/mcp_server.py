...
from mcp_server_qdrant.qdrant import ArbitraryFilter, Entry, Metadata, QdrantConnector, BatchEntry, CollectionInfo
    ...
    def setup_advanced_search_tools(self):
        ...
        if not self.qdrant_settings.read_only:
            ...
            async def batch_store(
                ...
                """Store multiple entries efficiently in a single operation."""
                try:
